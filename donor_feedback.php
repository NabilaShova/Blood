...
<div class="container">
  ...
  <form method="post" id="form1" action="donor_add_feedback.php" onSubmit="alert('Thank you for your feedback.');" >
    ...
    <label for="name" style="color: black;">Name:</label>
      ...
      <textarea class="form-control" rows="2" id="feedback" name="feedback"></textarea>
      <button type="submit" <a href="donor.php">Submit</a></button>
    </div>
  </form>
</div>
