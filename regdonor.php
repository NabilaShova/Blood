...
<ul><li><a href="login.html" style="text-align: center; font-size:30px;">Blood Donor's Network</a></li></ul>
  
<!--</nav>-->


<!--<button class="button button1" onclick="document.getElementById('id01').style.display='block'" style="width:300px;">Login</button>-->
<button class="button" onclick="document.getElementById('id01').style.display='block'" style="width:300px;">Donors Registration</button>
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="/blood/adddonor.php" method="POST">
    <div class="imgcontainer">
      <span onclick="document.getElementById('id01').style.display='none'" class="close" title="Close Modal">&times;</span>
      <img src="img_avatar2.svg" alt="LgImg" class="avatar">
    </div>
